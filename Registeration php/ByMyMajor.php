<?php
    ...
    , COURSE.courseDivide, COURSE.coursePersonnel, COURSE.courseTime FROM SCHEDULE, COURSE, USER_REG WHERE USER_REG.userMajor IN (SELECT 
    userMajor FROM USER_REG WHERE userID = '$userID') AND USER_REG.userID = SCHEDULE.userID AND SCHEDULE.courseID = COURSE.courseID GROUP BY
