<?php
    ...
    , COURSE.courseDivide, COURSE.coursePersonnel, COURSE.courseTime FROM COURSE, SCHEDULE, USER_REG WHERE USER_REG.userGender = '남자' AND USER_REG.
    userID = SCHEDULE.userID AND SCHEDULE.courseID = COURSE.courseID GROUP BY SCHEDULE.courseID ORDER BY COUNT(SCHEDULE.courseID) DESC 
    LIMIT 5;");
    $response = array();
