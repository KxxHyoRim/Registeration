...
public class CourseListAdapter extends BaseAdapter {
        ...
        addButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!already(courseIDList, courseList.get(i).getCourseID())) {
                    ...
                    AddRequest validateRequest = new AddRequest(userID, courseList.get(i).getCourseID() + "", responseListener);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute(){
            try {
                target = "https://youngwoo311.cafe24.com/ScheduleList.php?userID=" + URLEncoder.encode(userID, "UTF-8");
            }catch (Exception e){
                e.printStackTrace();
            }
        }
